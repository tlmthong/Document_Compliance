...
class PolicyDocument:
    ...
    self_fact: tuple = field(default_factory=tuple)
    self_fact_embed: tuple = field(default_factory=tuple)

    def __post_init__(self):
        """Automatically register this policy in the registry"""
        registry = PolicyRegistry()
        registry.register(self)
        self.self_fact_embed = EMBED_MODEL.encode(self.self_fact)["dense_vecs"]
...
class LawUnit:
    ...
    hypothetical_questions: tuple = field(default_factory=tuple)
    ...
    def __init__(
        ...
        try:
            ...
            self.hypothetical_questions = questions_list
...
def test_2():
    law_1 = LawUnit(
        type_unit="Article 1",
        content="""
 Maximum Interest Rate for deposits in Vietnam dong of organizations (except for credit institutions, foreign bank branches) and individuals at credit institutions, bank branches foreign goods as prescribed in Circular No. 48/2024/TT-NHNN dated September 30 in 2024 as follows:

1. The maximum interest rate applicable to deposits non-term and with a term of less than 1 month is 0.5%/year.

2. The maximum interest rate applicable to deposits with the term from 1 month to less than 6 months is 4.75%/year; the People's Credit Fund and Microfinance institutions apply the maximum interest rate for term deposits from 1 month to less than 6 months is 5.25%/year.
""",
    )
    law_2 = LawUnit(
        type_unit="Article 2",
        content="""1. This Decision takes effect effective from November 20, 2024 and replaces Decision No. 1124/QD-NHNN dated June 16, 2023 of the Governor of the State Bank of Vietnam on the minimum interest rate for deposits in Vietnam dong of organizations and individuals at credit institutions, branches of foreign banks as prescribed in Circular No. 07/2014/TT-NHNN dated March 17, 2014.

2. Interest rates on deposits in Vietnam dong of organizations and individuals at credit institutions and foreign bank branches incurred before the effective date of this Decision, they shall be implemented until the end of the time limit; upon the expiration of the agreed time limit, the organizations and individuals fail to come to receive the deposits, the credit institutions and foreign bank branches shall apply the interest rates on deposits under the provisions of this Decision.""",
    )
    law_3 = LawUnit(
        type_unit="Article 3",
        content="  The Chief of Office, the Head of the Monetary Policy Department and the Heads of units of the State Bank of Vietnam, credit institutions and foreign bank branches shall be responsible for the implementation of this Decision./.",
    )
    policy2 = PolicyDocument(
        id="2411/QD-NHNN",
        full_content="""
Article 1. Maximum Interest Rate for deposits in Vietnam dong of organizations (except for credit institutions, foreign bank branches) and individuals at credit institutions, bank branches foreign goods as prescribed in Circular No. 48/2024/TT-NHNN dated September 30 in 2024 as follows:
...
Article 3. The Chief of Office, the Head of the Monetary Policy Department and the Heads of units of the State Bank of Vietnam, credit institutions and foreign bank branches shall be responsible for the implementation of this Decision./.
""",
    ...
    list_fact_extract = [
        ...
        "This decision replaces Decision No. 1124/QD-NHNN dated June 16, 2023",
        "This decision stipulates the minimum interest rate for deposits in Vietnamese dong",
        "This decision is based on Circular No. 07/2014/TT-NHNN dated March 17, 2014",
        "This decision applies to organizations and individuals at credit institutions and foreign bank branches",
        "This decision applies the interest rate to deposits that are not withdrawn at the end of the agreed term",
        "This decision binds the implementation responsibility of the Head of Office",
        "This decision binds the implementation responsibility of the Head of Monetary Policy Department",
        "This decision binds the implementation responsibility of the units of the State Bank of Vietnam",
        "This decision binds the implementation responsibility of credit institutions",
        "This decision binds the implementation responsibility of foreign bank branches",
    ]
...
def test_3():
    ...
    print(unit.get_cross_references())
    ...
    unit = LawUnit(
        type_unit="Article",
        id="Article 5",
        content="As stated in Article 5 and Article 10...",
    )
    print(unit.get_cross_references())
